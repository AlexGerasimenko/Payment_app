    ...
    <tr>
        <td class="content">
            ...
            <form autocomplete="off" id="main_form" action="controller" method="post">
                        ...
                        <tr>
                            ...
                            <td>
                                <c:if test="${bean.statusId == 0}">
                                    <button type="submit" name="editPayment" value= ${bean.id}><fmt:message
                ...
                <button type="submit" name="sortBy" value="byDateAsc"><fmt:message
                        key="button.sort_by_ascending_date"/></button>
